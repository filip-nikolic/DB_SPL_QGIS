var size = 0;
var placement = 'point';
function categories_Locations_new_4(feature, value, size, resolution, labelText,
...
var style_Locations_new_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        value = clusteredFeatures[0].get("Objekt");
        if ("" !== null) {
            labelText = String("");
        }
    ...
    var style = categories_Locations_new_4(feature, value, size, resolution, labelText,
